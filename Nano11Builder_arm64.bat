...
title Nano11 Builder ARM64
echo Welcome to the Nano11 image creator for ARM64!
...
echo Removing Edge
cd "C:\scratchdir\program files\microsoft"
del Edge /s /q
del EdgeCore /s /q
del EdgeUpdate /s /q
...
dism /image:c:\scratchdir /Remove-Package /PackageName:Microsoft-Windows-LanguageFeatures-Handwriting-en-us-Package~31bf3856ad364e35~arm64~~10.0.22621.1265 > nul
echo Removing OCR:
dism /image:c:\scratchdir /Remove-Package /PackageName:Microsoft-Windows-LanguageFeatures-OCR-en-us-Package~31bf3856ad364e35~arm64~~10.0.22621.1265 > nul
echo Removing Speech:
dism /image:c:\scratchdir /Remove-Package /PackageName:Microsoft-Windows-LanguageFeatures-Speech-en-us-Package~31bf3856ad364e35~arm64~~10.0.22621.1265 > nul
echo Removing TTS:
